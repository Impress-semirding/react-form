...
import { get, isEqual, merge, set, isArray }  from 'lodash';
...
function useForm(createOptions = { name: new Date().getTime() }) {
  createOptions = createOptions;
  const { formData, getFormData, setFields, setFormData } = React.useContext(FormContext);
