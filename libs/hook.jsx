...
function getFieldDecorator(field, options) {
    return (component) => {
        ...
        return (<MemoComponent shouldCheckPropsKey={valuePropName ? valuePropName : 'value'} renderComponent={component} {...props} {...dynamicField} id={genField(id || field, createOptions.name)} onChange={onFieldChange(field)}>
        {children}
      </MemoComponent>);
    };
}
